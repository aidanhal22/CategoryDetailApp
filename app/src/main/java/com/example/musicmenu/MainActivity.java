        ...
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> listView,
                ...
                if (position == 0) {                    // they chose breakfast
                    for (Music f : Music.country) {      // add all the elements for this array to the arraylist
                        listData.add(f);
                    }
                } else if (position == 1) {
                    for (Music f : Music.hipHop) {        // they chose lunch
                        listData.add(f);
                    }
                } else if (position == 2) {
                    for (Music f : Music.pop) {        // they chose dinner
                        listData.add(f);
                    }
                }
